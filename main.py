...
button=Button(frame,text="ADD", font="arial 20 bold",width=6,bg="#dad5c0", fg="#fff",bd=0,command=addTask)
button.place(x=300,y=0)

#listbox
frame1= Frame(root,bd=3,width=700,height=280,bg="#dad5c0")
frame1.pack(pady=(160,0))

listbox=Listbox(frame1,font=('arial',12),width=40,height=16,bg="#dad5c0", fg="white",cursor="hand2",selectbackground="#a69cac")
